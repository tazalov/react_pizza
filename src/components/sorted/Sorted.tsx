...
export const Sorted: FC<SortedPT> = React.memo(
  ({ type, changeType, descOrder, toggleDescOrder }) => {
    useWhyDidYouUpdate('Sorted', { type, changeType, descOrder, toggleDescOrder })
